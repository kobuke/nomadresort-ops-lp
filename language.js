const translations = {
    en: {
        ...
        hero_badge: "50% reduction in management costs",
        ...
        solution_text: "With Nomad Resort OS, the Discord bot functions as an excellent secretary. From confirming participants to issuing payment links, reminding participants before the application deadline, and confirming those who have not yet paid.<br><br>All people have to do is 'plan' and 'get excited.' Leave the rest to the tools.",
        ...
        features_title: "Three mechanisms to reduce<br>the operational workload by '50%'",
    ...
    zh: {
        ...
        solution_text: "有了Nomad Resort OS，Discord机器人可以充当出色的秘书。从确认参与者到发放付款链接，在申请截止日期前提醒参与者，以及确认尚未付款的人。<br><br>人们所要做的就是“计划”和“兴奋”。剩下的交给工具吧。",
        ...
        features_tag: "功能",
        features_title: "将运营工作量减少“50%”的<br>三种机制",
    ...
    ja: {
        ...
        solution_text: "Nomad Resort OSは、Discordボットが優秀な秘書として機能します。参加者の確認から決済リンクの発行、参加者募集締切前のリマインド、決済未完了者の確認まで。<br><br>人がやるべきなのは「企画」と「熱狂」だけ。あとはツールにお任せください。",
        ...
        features_tag: "Features",
        features_title: "運営の手間を「50%」削減する、<br>3つの仕組み",
        ...
        authority_quote_author: "- 沖縄デジタルノマド運営スタッフ",
        price_badge: "RECOMMENDED",
    ...
    if (modal) {
        ...
        if (contactForm) {
            contactForm.addEventListener('submit', async (event) => {
                ...
                formData.append('_subject', '【Nomad Resort OS】導入相談フォームよりお問い合わせ');
